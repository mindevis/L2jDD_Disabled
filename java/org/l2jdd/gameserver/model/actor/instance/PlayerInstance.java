...
import org.l2jdd.gameserver.handler.skillhandlers.SiegeFlag;
import org.l2jdd.gameserver.handler.skillhandlers.StrSiegeAssault;
import org.l2jdd.gameserver.handler.skillhandlers.TakeCastle;
...
import org.l2jdd.gameserver.instancemanager.RebirthManager;
...
import org.l2jdd.gameserver.model.Fish;
import org.l2jdd.gameserver.model.Fishing;
...
import org.l2jdd.gameserver.model.Skill.SkillTargetType;
...
import org.l2jdd.gameserver.model.actor.knownlist.PlayerKnownList;
...
import org.l2jdd.gameserver.model.holders.PlayerStatsHolder;
...
import org.l2jdd.gameserver.model.itemcontainer.PetInventory;
...
import org.l2jdd.gameserver.model.quest.EventType;
...
import org.l2jdd.gameserver.model.skills.BaseStat;
import org.l2jdd.gameserver.model.skills.Formulas;
import org.l2jdd.gameserver.model.skills.Stat;
import org.l2jdd.gameserver.model.skills.effects.EffectCharge;
import org.l2jdd.gameserver.model.skills.handlers.SkillSummon;
...
import org.l2jdd.gameserver.model.zone.type.TownZone;
...
import org.l2jdd.gameserver.network.serverpackets.ExFishingEnd;
import org.l2jdd.gameserver.network.serverpackets.ExFishingStart;
...
import org.l2jdd.gameserver.network.serverpackets.MagicSkillCanceld;
...
import org.l2jdd.gameserver.network.serverpackets.PetInventoryUpdate;
...
import org.l2jdd.gameserver.network.serverpackets.SendTradeDone;
...
import org.l2jdd.gameserver.network.serverpackets.TitleUpdate;
import org.l2jdd.gameserver.network.serverpackets.TradePressOtherOk;
import org.l2jdd.gameserver.network.serverpackets.TradePressOwnOk;
...
public class PlayerInstance extends Playable
{
	...
	public void useMagic(Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (!target.canBeAttacked() && !getAccessLevel().allowPeaceAttack() && !target.isDoor() && (sklType != SkillType.TAKECASTLE))
		{
			sendPacket(ActionFailed.STATIC_PACKET);
			return;
		}
