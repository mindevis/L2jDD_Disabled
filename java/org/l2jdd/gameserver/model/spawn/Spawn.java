 ...
 */
package org.l2jdd.gameserver.model.spawn;
...
public class Spawn
{
	...
	public Spawn(NpcTemplate mobTemplate) throws ClassNotFoundException, NoSuchMethodException
	{
		...
		_constructor = Class.forName("org.l2jdd.gameserver.model.actor.instance." + implementationName + "Instance").getConstructor(parameters);
	}
